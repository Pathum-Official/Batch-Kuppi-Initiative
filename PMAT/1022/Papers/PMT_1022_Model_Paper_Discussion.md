...
> 🔗 **අදාළ පාඩම:** [Module 01: Foundations & Real Numbers](../Notes/01_Foundations_Real_Numbers_and_Base_Representations.md)
...
> 🔗 **අදාළ පාඩම:** [Module 03: Divisibility Theory](../Notes/03_Divisibility_Theory_and_Elementary_Properties.md)
...
> 🔗 **අදාළ පාඩම:** [Module 02: Induction & Well-Ordering Principle](../Notes/02_Mathematical_Induction_and_Well_Ordering_Principle.md)
* **$A$ කුලකය සඳහා:**
  * $n = 0 \implies 1$
  * $n = 1 \implies 1/4$
...
#### ✍️ Step-by-Step Solution:
> 🔗 **අදාළ පාඩම:** [Module 08: Modular Arithmetic](../Notes/08_Modular_Arithmetic_Congruences_and_Linear_Congruences.md)
...
> 🔗 **අදාළ පාඩම්:**
> * 📘 [Module 01: Foundations & Real Numbers](../Notes/01_Foundations_Real_Numbers_and_Base_Representations.md)
> * 📘 [Module 03: Divisibility Theory](../Notes/03_Divisibility_Theory_and_Elementary_Properties.md)
> * 📘 [Module 04: Division Algorithm & Integer Forms](../Notes/04_The_Division_Algorithm_and_Form_of_Integers.md)
> * 📘 [Module 05: Greatest Common Divisor & Bézout's Identity](../Notes/05_Greatest_Common_Divisor_and_Bezout_Identity.md)
...
> 🔗 **අදාළ පාඩම්:**
> * 📘 [Module 06: Euclidean Algorithm & Linear Diophantine Equations](../Notes/06_Euclidean_Algorithm_and_Linear_Diophantine_Equations.md)
> * 📘 [Module 04: Division Algorithm & Integer Forms](../Notes/04_The_Division_Algorithm_and_Form_of_Integers.md)
...
> 🔗 **අදාළ පාඩම්:**
> * 📘 [Module 05: Greatest Common Divisor & Bézout's Identity](../Notes/05_Greatest_Common_Divisor_and_Bezout_Identity.md)
> * 📘 [Module 07: Prime Numbers & Fundamental Theorem of Arithmetic](../Notes/07_Prime_Numbers_Factorization_and_Euclid_Lemmas.md)
