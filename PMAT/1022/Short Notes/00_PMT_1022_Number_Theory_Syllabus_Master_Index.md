...
```mermaid
graph TD
    A["PMT 1022 Introduction to Number Theory"] --> B["Module 01: Real Numbers, Axioms & Base Representations"]
    A --> C["Module 02: Mathematical Induction & Well-Ordering Principle"]
    A --> D["Module 03: Divisibility Theory & Elementary Properties"]
    A --> E["Module 04: The Division Algorithm & Forms of Integers"]
    A --> F["Module 05: Greatest Common Divisor & Bézout's Identity"]
    A --> G["Module 06: Euclidean Algorithm & Linear Diophantine Equations"]
    A --> H["Module 07: Prime Numbers & Fundamental Theorem of Arithmetic"]
    A --> I["Module 08: Modular Arithmetic & Linear Congruences"]
```
...
| :-: | :--- | :--- | :--- |
| **01** | [01. Foundations, Real Numbers & Base Representations](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/01_Foundations_Real_Numbers_and_Base_Representations.md) | [`01_Lesson_01`](../01_Lesson_01_Introduction_to_Number_Theory_and_Sets.pdf), [`01_Lesson_02`](../01_Lesson_02_Basis_Representation_of_Integers.pdf) | Sets of Numbers ($\mathbb{N}, \mathbb{Z}, \mathbb{Q}, \mathbb{R}$), Field & Order Axioms of $\mathbb{R}$, Absolute Value Properties, Base-$b$ Positional Representation, Base-conversion algorithms (Binary, Octal, Decimal, Hexadecimal) |
| **02** | [02. Mathematical Induction & Well-Ordering Principle](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/02_Mathematical_Induction_and_Well_Ordering_Principle.md) | [`02_Lesson_03`](../02_Lesson_03_Mathematical_Induction.pdf), [`02_Lesson_04`](../02_Lesson_04_Well_Ordering_Principle.pdf) | Weak Induction (Summations, Inequalities, Divisibility), Strong Induction, Well-Ordering Principle (WOP), Least Element Definition, Archimedean Property of $\mathbb{R}$, Equivalence of WOP & Induction |
| **03** | [03. Divisibility Theory & Elementary Properties](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/03_Divisibility_Theory_and_Elementary_Properties.md) | [`03_Lesson_05`](../03_Lesson_05_Divisibility_Theory_and_Properties.pdf) | Formal Divisibility Relation ($a \mid b$), 10 Master Divisibility Theorems, Linear Combination Theorem ($a \mid b \land a \mid c \implies a \mid (bx + cy)$), Bounds & Parity of Integers |
| **04** | [04. The Division Algorithm & Forms of Integers](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/04_The_Division_Algorithm_and_Form_of_Integers.md) | [`04_Lesson_06`](../04_Lesson_06_The_Division_Algorithm_Part_1.pdf), [`04_Lesson_07`](../04_Lesson_07_Division_Algorithm_Applications_and_Parity.pdf) | The Division Algorithm ($a = bq + r, 0 \le r < b$), Existence and Uniqueness Proofs, Forms of Integers ($2k, 2k+1, 3k+r, 4k+r$), Last-digit analysis, Perfect square characterization ($4k$ or $4k+1$) |
| **05** | [05. Greatest Common Divisor & Bézout's Identity](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/05_Greatest_Common_Divisor_and_Bezout_Identity.md) | [`05_Lesson_08`](../05_Lesson_08_Greatest_Common_Divisor_and_Properties.pdf) | Definition of $\gcd(a, b)$, Properties of $\gcd$, Relatively Prime (Coprime) Integers ($\gcd(a, b) = 1$), Bézout's Identity ($\gcd(a, b) = \min\{ax + by > 0\}$), Characterization of $\gcd$ as Linear Combination |
| **06** | [06. Euclidean Algorithm & Linear Diophantine Equations](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/06_Euclidean_Algorithm_and_Linear_Diophantine_Equations.md) | [`06_Lesson_09`](../06_Lesson_09_Euclidean_Algorithm_and_Diophantine_Equations.pdf) | The Euclidean Algorithm, Extended Euclidean Algorithm (Back-substitution for Bézout coefficients), Linear Diophantine Equations $ax + by = c$, Solvability Criterion ($\gcd(a, b) \mid c$), General Integer Solutions Formula |
| **07** | [07. Prime Numbers & Fundamental Theorem of Arithmetic](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/07_Prime_Numbers_Factorization_and_Euclid_Lemmas.md) | [`07_Lesson_10`](../07_Lesson_10_Primes_and_Fundamental_Theorem_of_Arithmetic.pdf) | Prime vs Composite Integers, Sieve of Eratosthenes, Euclid's Lemma ($p \mid ab \implies p \mid a \lor p \mid b$), Fundamental Theorem of Arithmetic (FTA - Existence and Uniqueness of Prime Factorization), Infinitude of Primes ($4k+3$ forms) |
| **08** | [08. Modular Arithmetic & Linear Congruences](file:///c:/Project/Learning_with_ai/PMAT/PMT%201022%20Introduction%20to%20Number%20Theory/Notes/08_Modular_Arithmetic_and_Congruences.md) | [`08_Lesson_11`](../08_Lesson_11_Modular_Arithmetic_and_Congruences.pdf) | Congruence Relation ($a \equiv b \pmod m$), Basic Properties of Congruences, Arithmetic Compatibility ($+ , \times$), Complete Residue Systems Modulo $m$, Linear Congruences ($ax \equiv b \pmod m$) |
...
| :--- | :--- | :--- |
| **PMT 1022 Model Examination Paper** | [`model paper.pdf`](../Papers/model%20paper.pdf) | [PMT 1022 Model Paper Master Discussion](../Papers/PMT_1022_Model_Paper_Discussion.md) |
| **Practice Problems for Assignment 01** | [`Practice problems for assignment 01.pdf`](../Papers/Practice%20problems%20for%20assignment%2001.pdf) | [Assignment 01 Practice Discussion](../Papers/PMT_1022_Practice_Assignment_01_Discussion.md) |
| **PMT 1022 Practice Problems** | [`practice problems.pdf`](../Papers/practice%20problems.pdf) | [Practice Problems Master Discussion](../Papers/PMT_1022_Practice_Problems_Master_Discussion.md) |
