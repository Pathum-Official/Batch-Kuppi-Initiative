...
```mermaid
graph TD
    A["PMT 1013 Foundations of Mathematics"] --> B["Module 01: Propositional Logic & Truth Tables"]
    A --> C["Module 02: Predicates, Quantifiers & Inference Rules"]
    A --> D["Module 03: Proof Techniques & Number Theory"]
    A --> E["Module 04: Mathematical Induction (Weak & Strong)"]
    A --> F["Module 05: Set Theory Operations & Element Proofs"]
    A --> G["Module 06: Indexed Families of Sets & Partitions"]
    A --> H["Module 07: Binary Relations, Inverses & Compositions"]
    A --> I["Module 08: Equivalence Relations & Congruence Classes"]
    A --> J["Module 09: Posets, Hasse Diagrams & Lattices"]
    A --> K["Module 10: Functions, Direct/Inverse Images & Bijectivity"]
    A --> L["Module 11: Set Cardinality, Countability & Cantor Theorems"]
```
...
| :-: | :--- | :--- | :--- |
| **01** | [01. Propositional Logic & Truth Tables](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/01_Logic_Propositions_and_Truth_Tables.md) | [`01_D01`](../01_D01_Logic_and_Statements.pdf), [`01_D03`](../01_D03_Propositional_Logic_and_Truth_Tables.pdf) | Statements, Logical Connectives ($\land, \lor, \neg, \to, \leftrightarrow$), Truth Tables, Tautologies, Contradictions, Logical Equivalences, Laws of Logic |
| **02** | [02. Predicates, Quantifiers & Inference Rules](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/02_Predicates_Quantifiers_and_Rules_of_Inference.md) | [`02_D04`](../02_D04_Predicates_and_Quantifiers.pdf), [`02_D05`](../02_D05_Rules_of_Inference_and_Arguments.pdf) | Predicates $P(x)$, Universal $\forall$, Existential $\exists$, Negating Quantifiers, Nested Quantifiers, Rules of Inference (Modus Ponens, Modus Tollens, Syllogism), Formal Valid/Invalid Arguments |
| **03** | [03. Proof Techniques & Number Theory](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/03_Proof_Techniques_and_Number_Theory_Foundations.md) | [`01_D01`](../01_D01_Logic_and_Statements.pdf), [`01_D02`](../01_D02_Proof_Techniques_Intro.pdf), [`03_D06`](../03_D06_Number_Theory_Divisibility_Proofs.pdf) | Axioms, Definitions, Conjectures, Direct Proof, Contrapositive ($P \to Q \equiv \neg Q \to \neg P$), Contradiction ($P \land \neg Q \implies \mathbf{F}$), Counterexamples, Divisibility in $\mathbb{Z}$ ($a\|b$), Division Algorithm |
| **04** | [04. Mathematical Induction & Strong Induction](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/04_Mathematical_Induction_and_Strong_Induction.md) | [`04_D07`](../04_D07_Mathematical_Induction.pdf), [`04_D08`](../04_D08_Strong_Induction_and_Well_Ordering.pdf) | Principle of Mathematical Induction (Base Step, Inductive Step), Summation Identities, Inequalities, Divisibility by Induction, Strong Induction, Well-Ordering Principle, Fibonacci & Recurrences |
| **05** | [05. Set Theory Operations & Algebraic Proofs](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/05_Set_Theory_Operations_and_Algebraic_Proofs.md) | [`05_D09`](../05_D09_Set_Theory_Operations_and_Cartesian_Product.pdf), [`05_D10`](../05_D10_Set_Identities_and_Element_Proofs.pdf) | Set Definitions, Subsets ($A \subseteq B$), Power Set $\mathcal{P}(A)$, Cartesian Product $A \times B$, Set Operations ($\cup, \cap, \setminus, \triangle, A^c$), Element Method (Double Inclusion proofs: $X \subseteq Y$ and $Y \subseteq X$) |
| **06** | [06. Indexed Families of Sets & Partitions](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/06_Indexed_Families_of_Sets_and_Partitions.md) | [`06_D11`](../06_D11_Indexed_Families_of_Sets.pdf), [`06_D12`](../06_D12_Set_Partitions_and_Inclusion_Exclusion.pdf) | Indexed Collections $\{A_\alpha\}_{\alpha \in \Lambda}$, Generalized $\bigcup_{\alpha \in \Lambda} A_\alpha$ and $\bigcap_{\alpha \in \Lambda} A_\alpha$, Generalized De Morgan's Laws, Distributive Laws, Partitions of Sets, Disjoint Collections |
| **07** | [07. Binary Relations & Properties](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/07_Binary_Relations_and_Properties.md) | [`07_D13`](../07_D13_Binary_Relations_and_Compositions.pdf), [`07_D14`](../07_D14_Relation_Properties_and_Proofs.pdf) | Binary Relations $R \subseteq A \times B$, Domain, Codomain, Range, Matrix & Digraph Representations, Inverse Relations $R^{-1}$, Composition $R \circ S$, Properties: Reflexive, Symmetric, Antisymmetric, Transitive (Algebraic characterizations) |
| **08** | [08. Equivalence Relations & Congruence Classes](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/08_Equivalence_Relations_and_Congruence_Classes.md) | [`08_D15`](../08_D15_Equivalence_Relations_and_Partitions.pdf) | Equivalence Relations, Equivalence Classes $[x]$, Fundamental Theorem of Equivalence Relations (Partition Theorem $A = \bigcup [x]$), Congruence Modulo $n$ ($a \equiv b \pmod n$), Quotient Sets $\mathbb{Z}_n$ |
| **09** | [09. Posets, Hasse Diagrams & Lattices](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/09_Partial_Orders_Posets_Hasse_Diagrams_and_Lattices.md) | [`09_D16`](../09_D16_Partial_Orders_Posets_and_Hasse_Diagrams.pdf), [`09_D17`](../09_D17_Lattices_and_Total_Orders.pdf) | Partial Order Relations (Posets $(A, \le)$), Hasse Diagrams, Chains & Antichains, Maximal, Minimal, Greatest, Least Elements, Upper/Lower Bounds, LUB (Supremum), GLB (Infimum), Lattices |
| **10** | [10. Functions, Direct/Inverse Images & Bijectivity](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/10_Functions_Injectivity_Surjectivity_and_Set_Images.md) | [`10_D18`](../10_D18_Functions_Injectivity_and_Surjectivity.pdf), [`10_D19`](../10_D19_Function_Composition_and_Inverses.pdf), [`10_D20`](../10_D20_Direct_and_Inverse_Images_under_Functions.pdf) | Function Definitions, Injective (1-1), Surjective (Onto), Bijective, Direct Image $f(U)$, Inverse Image $f^{-1}(V)$, Algebraic Set Properties of Images, Function Composition $g \circ f$, Invertibility Criteria |
| **11** | [11. Set Cardinality, Countability & Cantor Theorems](file:///c:/Project/Learning_with_ai/PMAT/PMT%201013%20Foundations%20of%20Mathematics/Notes/11_Cardinality_Countability_and_Cantor_Theorems.md) | [`11_D21`](../11_D21_Cardinality_and_Countable_Sets.pdf), [`11_D22`](../11_D22_Uncountability_and_Cantor_Theorems.pdf), [`11_D23`](../11_D23_Proof_Techniques_Synthesis_and_Review.pdf), [`11_D24`](../11_D24_Course_Summary_and_Exam_Prep.pdf) | Finite & Infinite Sets, Equinumerous Sets ($A \approx B$), Countable (Denumerable) Sets ($\mathbb{N}, \mathbb{Z}, \mathbb{Q}$), Uncountable Sets ($\mathbb{R}$, intervals $(0,1)$), Cantor's Diagonal Argument, Cantor's Theorem ($|A| < |\mathcal{P}(A)|$), Cantor-Schröder-Bernstein Theorem |
...
| :--- | :--- | :--- |
| **End-Exam 2026 Model Paper** | [`End-Exam 2026 Model Paper.pdf`](../Papers/End-Exam%202026%20Model%20Paper.pdf) | [End-Exam 2026 Model Paper Master Discussion](../Papers/End-Exam_2026_Model_Paper_Discussion.md) |
